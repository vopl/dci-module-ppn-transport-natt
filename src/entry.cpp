...
namespace dci::module::ppn::transport::natt
{
    namespace
    {
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Natt>(ilid, this)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::transport::natt::entry_;
}
